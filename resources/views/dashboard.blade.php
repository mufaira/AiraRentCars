        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                    ...
                    <!-- Katalog Mobil -->
                    <a href="{{ route('cars.catalog') }}" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                    ...
                    <!-- Riwayat Sewa -->
                    <a href="{{ route('rentals.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                    ...
                    <!-- Profil Saya -->
                    <a href="{{ route('profile.edit') }}" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                ...
                                <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 group-hover:border-yellow-500 rounded-2xl overflow-hidden transition duration-300">
                                    ...
                                    <div class="p-6 relative z-10">
                                        <div class="flex items-start justify-between mb-3">
                                            <h3 class="text-lg font-bold text-white group-hover:text-yellow-500 transition flex-1">{{ $car->name }}</h3>
                        ...
                        @foreach ($availableCars as $car)
                            <a href="{{ route('cars.detail', $car) }}" class="group relative">
                                ...
                                <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 group-hover:border-green-500 rounded-2xl overflow-hidden transition duration-300">
                                    ...
                                    <div class="p-6 relative z-10">
                                        <div class="flex items-start justify-between mb-3">
                                            <h3 class="text-lg font-bold text-white group-hover:text-green-500 transition flex-1">{{ $car->name }}</h3>
                                            <div class="ml-2 flex-shrink-0">
                        ...
                        @foreach ($unavailableCars as $car)
                            <div class="group bg-[#1a1a1a] border border-white/10 rounded-xl overflow-hidden opacity-60">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-gray-400 text-sm mb-3">{{ $car->transmission }} • {{ $car->capacity }} orang</p>
                                    <p class="text-[#f53003] font-bold text-lg">Rp {{ number_format($car->price_per_day, 0, ',', '.') }}/hari</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
