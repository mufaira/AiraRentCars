        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-12">
                <div class="flex items-center gap-3 mb-4">
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-[#f53003] transition">
                            ...
                            <div class="relative z-10 p-6 md:p-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <h3 class="text-xl font-bold text-white group-hover:text-[#f53003] transition mb-3"><?php echo e($rental->car->name); ?></h3>
                                        <div class="flex items-center gap-3 text-gray-400 text-sm">
                                            ...
                                            <span><?php echo e($rental->car->capacity); ?> penumpang • <?php echo e($rental->car->transmission); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-white font-semibold mb-1"><?php echo e($rental->rental_date->format('d M Y')); ?></p>
                                        <p class="text-gray-400 text-sm"><?php echo e($rental->duration_days); ?> hari</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold bg-gradient-to-r from-[#f53003] to-orange-500 bg-clip-text text-transparent">
                                            Rp <?php echo e(number_format($rental->total_price, 0, ',', '.')); ?>
                                        ...
                                        <div class="space-y-2">
                                            <div>
                                                <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold transition
                                                    ...
                                                    <?php elseif($rental->status === 'Completed'): ?> bg-purple-500/20 text-purple-400 border border-purple-500/50
                                                    <?php else: ?> bg-red-500/20 text-red-400 border border-red-500/50
                                                    <?php endif; ?>">
                                                    <span class="w-2 h-2 rounded-full <?php if($rental->status === 'Pending'): ?> bg-yellow-400 <?php elseif($rental->status === 'Paid'): ?> bg-blue-400 <?php elseif($rental->status === 'Active'): ?> bg-green-400 <?php elseif($rental->status === 'Completed'): ?> bg-purple-400 <?php else: ?> bg-red-400 <?php endif; ?>"></span>
                                            ...
                                            <?php if($rental->payment): ?>
                                                <div>
                                                    <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold
                                                        ...
                                                        <?php else: ?> bg-red-500/20 text-red-400 border border-red-500/50
                                                        <?php endif; ?>">
                                                        <span class="w-2 h-2 rounded-full <?php if($rental->payment->status === 'Pending'): ?> bg-yellow-400 <?php elseif($rental->payment->status === 'Verified'): ?> bg-green-400 <?php else: ?> bg-red-400 <?php endif; ?>"></span>
                                ...
                                <div class="flex flex-wrap gap-3 pt-6 border-t border-white/10">
                                    <a href="<?php echo e(route('rentals.show', $rental)); ?>" class="inline-flex items-center gap-2 bg-[#f53003] hover:bg-[#d63000] text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
                                    ...
                                    <?php if($rental->status !== 'Completed' && !$rental->payment): ?>
                                        <a href="<?php echo e(route('rentals.payment', $rental)); ?>" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-24">
                    ...
                    <a href="<?php echo e(route('cars.catalog')); ?>" class="inline-flex items-center gap-2 bg-[#f53003] hover:bg-[#d63000] text-white px-6 py-3 rounded-lg font-bold transition duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH D:\UAS PEMWEB\Part 3\resources\views/rentals/index.blade.php ENDPATH**/ ?>