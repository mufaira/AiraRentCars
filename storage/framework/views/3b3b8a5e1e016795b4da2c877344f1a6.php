...
<div class="container mx-auto px-4 py-10 max-w-5xl">
    <a href="<?php echo e(route('refunds.admin.index')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold text-base mb-8 transition group">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="info-card">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="info-value"><?php echo e($refund->rental->user->name); ?></div>
                    </div>
                    <div>
                        <div class="info-label">Email</div>
                        <div class="info-value"><?php echo e($refund->rental->user->email); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="info-value"><?php echo e($refund->rental->car->name); ?></div>
                    </div>
                    <div>
                        <div class="info-label">Status Rental</div>
                        <div class="info-value"><?php echo e($refund->rental->status); ?></div>
                    </div>
                    <div>
                        <div class="info-label">Tanggal Sewa</div>
                        <div class="info-value"><?php echo e($refund->rental->rental_date->format('d M Y')); ?></div>
                    </div>
                    <div>
                        <div class="info-label">Durasi</div>
                        <div class="info-value"><?php echo e($refund->rental->duration_days); ?> hari</div>
                    </div>
                    <div>
                        <div class="info-label">Total Harga</div>
                        <div class="info-value font-bold text-amber-600">Rp <?php echo e(number_format($refund->rental->total_price, 0, ',', '.')); ?></div>
                    </div>
                    <div>
                        <div class="info-label">Status Pembayaran</div>
                        <div class="info-value">
                            <?php if($refund->rental->payment): ?>
                                <?php echo e($refund->rental->payment->status); ?>
            ...
            <div class="info-card">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="info-value"><?php echo e($refund->reason_text); ?></div>
                    </div>

                    <?php if($refund->custom_reason): ?>
                        <div>
                            <div class="info-label">Penjelasan Tambahan</div>
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm text-gray-700 leading-relaxed"><?php echo e($refund->custom_reason); ?></div>
                        </div>
                    <?php endif; ?>

                    <div>
                        <div class="info-label">Jumlah Refund</div>
                        <div class="text-2xl font-bold text-amber-600">Rp <?php echo e(number_format($refund->refund_amount, 0, ',', '.')); ?></div>
                    </div>

                    <div>
                        <div class="info-label">Tanggal Request</div>
                        <div class="info-value"><?php echo e($refund->created_at->format('d M Y H:i')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <?php if($refund->status === 'Pending'): ?>
                <div class="info-card border-2 border-amber-200 bg-amber-50">
                    ...
                    <form action="<?php echo e(route('refunds.process', $refund)); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                ...
                <div class="info-card">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div>
                                <span class="status-badge
                                    <?php if($refund->status === 'Approved'): ?> status-approved
                        ...
                        <div>
                            ...
                            <div class="info-value"><?php echo e($refund->processed_at ? $refund->processed_at->format('d M Y H:i') : '-'); ?></div>
                        </div>

                        <?php if($refund->admin_notes): ?>
                            <div>
                                <div class="info-label">Catatan Admin</div>
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm text-gray-700 leading-relaxed"><?php echo e($refund->admin_notes); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="info-card border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-amber-100 sticky top-4">
                ...
                <div class="mb-6 pb-6 border-b-2 border-amber-200">
                    <div class="text-3xl font-bold text-amber-600 mb-2">
                        Rp <?php echo e(number_format($refund->refund_amount, 0, ',', '.')); ?>
...
<?php endif; ?>
<?php /**PATH D:\UAS PEMWEB\Part 3\resources\views/admin/refunds/show.blade.php ENDPATH**/ ?>