        ...
        <header class="fixed top-0 z-50 w-full glass-nav border-b border-gray-200/50 dark:border-white/10 transition-all duration-300">
            <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="hidden sm:block px-4 py-2 text-sm font-bold text-black bg-white rounded-full hover:bg-gray-200 hover:shadow-lg transition">
                                    Daftar Sekarang
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
                ...
                <div id="mobileMenu" class="hidden md:hidden border-t border-white/10 py-4 space-y-3">
                    ...
                    <a href="<?php echo e(route('cars.catalog')); ?>" class="block px-4 py-2 text-sm font-medium text-[#f53003] hover:bg-white/5 rounded transition">Katalog</a>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="border-t border-white/10 pt-3 space-y-2">
                            <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-sm font-bold hover:text-[#f53003] transition">Masuk</a>
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 text-sm font-bold text-black bg-white rounded-lg hover:bg-gray-200 transition">Daftar Sekarang</a>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
