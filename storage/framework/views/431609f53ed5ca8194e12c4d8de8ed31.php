...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Edit Artikel Blog')); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('admin.blogs.update', $blog)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:border-gray-600" rows="2"><?php echo e(old('excerpt', $blog->excerpt)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($blog->featured_image): ?>
                                <div class="mb-3">
                                    <img src="<?php echo e(asset('storage/' . $blog->featured_image)); ?>" alt="<?php echo e($blog->title); ?>" class="max-w-xs rounded">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" class="mr-2" value="1" <?php echo e(old('is_published', $blog->is_published) ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH D:\UAS PEMWEB\Part 3\resources\views/admin/blogs/edit.blade.php ENDPATH**/ ?>