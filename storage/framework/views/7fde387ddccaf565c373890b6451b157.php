        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex gap-8">
                    ...
                    <a href="<?php echo e(route('cars.catalog')); ?>" class="text-gray-400 hover:text-white transition">Katalog</a>
                    <a href="<?php echo e(route('rentals.index')); ?>" class="text-gray-400 hover:text-white transition">Rental Saya</a>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="text-gray-400 hover:text-white transition">Profil</a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#f53003] transition">Admin Panel</h3>
                            <p class="text-gray-400 text-sm mb-6 leading-relaxed">Kelola semua aspek aplikasi dengan statistik dan menu management.</p>
                    ...
                    <!-- Katalog Mobil -->
                    <a href="<?php echo e(route('cars.catalog')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#f53003] transition">Katalog Mobil</h3>
                            <p class="text-gray-400 text-sm mb-6 leading-relaxed">Lihat semua mobil yang tersedia dengan berbagai filter pencarian.</p>
                            <div class="flex items-center gap-2 text-[#f53003] font-bold group-hover:gap-3 transition">
                    ...
                    <!-- Riwayat Sewa -->
                    <a href="<?php echo e(route('rentals.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#f53003] transition">Riwayat Sewa</h3>
                            <p class="text-gray-400 text-sm mb-6 leading-relaxed">Lihat daftar sewa Anda dan status pembayaran dengan detail.</p>
                            <div class="flex items-center gap-2 text-[#f53003] font-bold group-hover:gap-3 transition">
                    ...
                    <!-- Profil Saya -->
                    <a href="<?php echo e(route('profile.edit')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                        <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#f53003] transition">Profil Saya</h3>
                            <p class="text-gray-400 text-sm mb-6 leading-relaxed">Kelola informasi profil dan pengaturan keamanan akun Anda.</p>
                            <div class="flex items-center gap-2 text-[#f53003] font-bold group-hover:gap-3 transition">
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <?php $__currentLoopData = $featuredCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('cars.detail', $car)); ?>" class="group relative">
                                ...
                                <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 group-hover:border-yellow-500 rounded-2xl overflow-hidden transition duration-300">
                                    <!-- Image Container -->
                                    <div class="relative h-56 overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                                        <?php if($car->featured_photo): ?>
                                            <img src="<?php echo e(asset('storage/' . $car->featured_photo->photo_path)); ?>" 
                                                 alt="<?php echo e($car->name); ?>" class="w-full h-full object-cover group-hover:scale-125 transition duration-500">
                                        <?php else: ?>
                                    ...
                                    <div class="p-6 relative z-10">
                                        <div class="flex items-start justify-between mb-3">
                                            <h3 class="text-lg font-bold text-white group-hover:text-yellow-500 transition flex-1"><?php echo e($car->name); ?></h3>
                                        ...
                                        <div class="flex items-center gap-2 text-gray-400 text-sm mb-4">
                                            ...
                                            <span><?php echo e($car->capacity); ?> penumpang</span>
                                        ...
                                        <!-- CTA Button -->
                                        <div class="flex items-center gap-2 text-yellow-500 font-bold group-hover:gap-3 transition">
                        ...
                        <?php $__currentLoopData = $availableCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('cars.detail', $car)); ?>" class="group relative">
                                ...
                                <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 group-hover:border-green-500 rounded-2xl overflow-hidden transition duration-300">
                                    ...
                                    <div class="p-6 relative z-10">
                                        <div class="flex items-start justify-between mb-3">
                                            <h3 class="text-lg font-bold text-white group-hover:text-green-500 transition flex-1"><?php echo e($car->name); ?></h3>
                                            <div class="ml-2 flex-shrink-0">
                                        ...
                                        <div class="mb-4 pb-4 border-b border-white/10">
                                            <p class="text-gray-400 text-xs uppercase tracking-wide mb-1">Harga sewa per hari</p>
                                            <p class="text-2xl font-bold bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">
                                                Rp <?php echo e(number_format($car->price_per_day, 0, ',', '.')); ?>
                                        ...
                                        <!-- CTA Button -->
                                        <div class="flex items-center gap-2 text-green-500 font-bold group-hover:gap-3 transition">
            ...
            <?php if($unavailableCars->count() > 0): ?>
                <div class="mb-12">
                    <h2 class="text-3xl font-bold text-white mb-8">❌ Mobil Sedang Disewa</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <?php $__currentLoopData = $unavailableCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group bg-[#1a1a1a] border border-white/10 rounded-xl overflow-hidden opacity-60">
                                <div class="relative h-48 overflow-hidden bg-gray-800">
                                    ...
                                    <div class="absolute top-3 right-3">
                                        <span class="bg-red-500 text-white px-3 py-1 rounded-lg text-xs font-bold">Disewa</span>
                                    </div>
                                </div>
                                <div class="p-4">
                                    <h3 class="text-lg font-bold text-white mb-2"><?php echo e($car->name); ?></h3>
                                    <p class="text-gray-400 text-sm mb-3"><?php echo e($car->transmission); ?> • <?php echo e($car->capacity); ?> orang</p>
                                    <p class="text-[#f53003] font-bold text-lg">Rp <?php echo e(number_format($car->price_per_day, 0, ',', '.')); ?>/hari</p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="<?php echo e(route('rentals.index')); ?>" class="text-gray-400 hover:text-[#f53003] transition">Rental Saya</a></li>
                    </ul>
                </div>
                <div>
...
<?php /**PATH D:\UAS PEMWEB\Part 3\resources\views/dashboard.blade.php ENDPATH**/ ?>