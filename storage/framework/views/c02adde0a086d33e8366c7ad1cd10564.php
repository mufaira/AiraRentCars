...
<div class="min-h-screen bg-black text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <!-- Infografis -->
            <a href="<?php echo e(route('dashboard.infografis')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
            ...
            <!-- Kelola Mobil -->
            <a href="<?php echo e(route('cars.admin.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
            ...
            <!-- Tambah Mobil -->
            <a href="<?php echo e(route('cars.admin.create')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
            ...
            <!-- Kelola Rental -->
            <a href="<?php echo e(route('rentals.admin.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
            ...
            <!-- Kelola Refund -->
            <a href="<?php echo e(route('refunds.admin.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="absolute -top-20 -right-20 w-40 h-40 bg-[#f53003]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
            ...
            <!-- Manajemen User -->
            <a href="<?php echo e(route('admin.users.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-8 hover:border-[#f53003] transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-[#f53003]/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-gradient-to-br from-[#f53003]/30 to-[#f53003]/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition duration-300">
                        <svg class="w-8 h-8 text-[#f53003]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($stats['total_cars'] ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($stats['total_rentals'] ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($stats['total_users'] ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1a] via-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-[#f53003]">Rp <?php echo e(number_format($stats['total_revenue'] ?? 0, 0, ',', '.')); ?></p>
                    </div>
...
<?php endif; ?><?php /**PATH D:\UAS PEMWEB\Part 3\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>