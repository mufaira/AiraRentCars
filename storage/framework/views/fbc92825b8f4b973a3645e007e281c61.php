                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="px-5 py-2.5 text-sm font-bold text-white bg-[#1b1b18] dark:bg-white dark:text-black rounded-full hover:shadow-lg transition transform hover:-translate-y-0.5">
                                    Daftar Sekarang
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20">
                <div class="max-w-2xl animate-fade-in-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('cars.catalog')); ?>" class="px-8 py-4 bg-[#f53003] text-white font-bold rounded-xl shadow-lg shadow-orange-600/40 hover:bg-[#d63000] hover:scale-105 transition duration-300 text-center">
                            Lihat Katalog Mobil
                        </a>
                        ...
                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group relative bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 hover:-translate-y-2 border border-transparent dark:border-white/5 dark:hover:border-[#f53003]/30">
                                <div class="relative h-48 w-full overflow-hidden bg-gray-200">
                                    <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?q=80&w=800&auto=format&fit=crop" alt="<?php echo e($car->name); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition duration-700">
                                ...
                                <div class="p-6">
                                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($car->name); ?></h3>
