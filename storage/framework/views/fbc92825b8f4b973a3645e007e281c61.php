            ...
            <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 sm:h-20">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3">
                        ...
                        <button id="mobileMenuBtn" class="md:hidden p-2 text-gray-700 dark:text-white hover:text-white dark:hover:text-white hover:bg-gray-900/20 dark:hover:bg-white/10 transition rounded-lg">
                ...
                <div id="mobileMenu" class="hidden md:hidden border-t border-gray-200/50 dark:border-white/10 py-4 space-y-3">
                    ...
                    <a href="<?php echo e(route('cars.catalog')); ?>" class="block px-4 py-2 text-sm font-medium text-white dark:text-white hover:text-[#f53003] hover:bg-gray-900/10 dark:hover:bg-gray-100/10 rounded transition">Katalog</a>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="border-t border-gray-200/50 dark:border-white/10 pt-3 space-y-2">
                            <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-sm font-bold text-white dark:text-white hover:text-[#f53003] transition">Masuk</a>
                            <?php if(Route::has('register')): ?>
